...
//prueba de metodos
console.log(
  "El total de kilometros recorridos en la hoja es: ",
  hojaruta1.calcularTotalKilometros(),
);
console.log(
  "El total de kilometros recorridos en la hoja 2 es: ",
  hojaruta2.calcularTotalKilometros(),
);
console.log(
  "El total de kilometros recorridos en la hoja 3 es: ",
  hojaruta3.calcularTotalKilometros(),
);
