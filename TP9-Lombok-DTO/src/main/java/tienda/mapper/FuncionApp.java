...
//        ProductoRepository pror = new ProductoRepository();
        ...
        Pedido f1 = Pedido.builder().cliente(cliente1).fecha(LocalDate.of(2024,4,10)).build();
        Pedido f2 = Pedido.builder().cliente(cliente1).fecha(LocalDate.of(2024,5,12)).build();
        Pedido f3 = Pedido.builder().cliente(cliente1).fecha(LocalDate.of(2024,6,11)).build();

        Pedido m1 = Pedido.builder().cliente(cliente1).fecha(LocalDate.of(2023,7,22)).build();
        Pedido m2 = Pedido.builder().cliente(cliente1).fecha(LocalDate.of(2023,8,20)).build();
        Pedido m3 = Pedido.builder().cliente(cliente1).fecha(LocalDate.of(2023,9,21)).build();
