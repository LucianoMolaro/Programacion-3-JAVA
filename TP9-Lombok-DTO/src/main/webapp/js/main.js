...
if (boton) {
    boton.addEventListener("click", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        div === null || div === void 0 ? void 0 : div.classList.add('botonIniciar--ocultar');
        const table = document.querySelector("section");
        table === null || table === void 0 ? void 0 : table.classList.remove("info--ocultar");
        yield cargarPedidos();
        yield cargarTabla();
    }));
}
function cargarPedidos() {
    return __awaiter(this, void 0, void 0, function* () {
        const respuesta = yield fetch("http://localhost:3000/SvPedido/CrearPedidos", {
            method: "POST",
            headers: {
